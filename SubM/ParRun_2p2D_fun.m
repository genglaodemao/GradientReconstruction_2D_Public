function []=ParRun_2p2D_fun(imagepath,folder,BG,gr,Rguess,Rreal,Intensity,Rangey,Rangex,Gkernel,Rcut,codepath,M,N)
%two particle
cd(codepath);
%
mkdir respar2p
...
if ifdo
    ...
    [res] = im2pos_Gradient_2p(im,gr,Rguess,Rreal,Intensity,Rcut);
