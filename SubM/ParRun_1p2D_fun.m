function []=ParRun_1p2D_fun(imagepath,folder,BG,gr,Rguess,Rreal,Intensity,Rangey,Rangex,Gkernel,Rcut,codepath,M,N)
%two particle
cd(codepath);
%
mkdir respar2p
...
if ifdo
    ...
    [res] = im2pos_Gradient_1p(im,gr,Rguess,Rreal,Intensity,Rcut);
    parsave(codepath,folder1,folder, id, res);
end
end
end
time = toc;
