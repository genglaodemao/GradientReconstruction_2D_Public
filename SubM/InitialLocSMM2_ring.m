function [r,bestH]=InitialLocSMM2_ring(im,R,ifplot)
...
step=0.5; %step of size in pixel, increase step to save time, decrease step to gain accuracy. Normally meaningless is smaller than 0.1.
...
[r,~] = featureH(im,pN,bestH,bestR-1,R-1,step,iffilter,masscut,mask);
if isempty(r) == 0 
    if length(r(:,1))==2
    r(:,1)=r(:,1);
    r(:,2)=r(:,2);
    else
        r=[10 10 5 1; 10 10 5 1];
    end
else
    r=[10 10 5 1; 10 10 5 1];
end
