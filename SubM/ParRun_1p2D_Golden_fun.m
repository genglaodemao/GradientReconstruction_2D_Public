function []=ParRun_1p2D_Golden_fun(imagepath,folder,BG,gr,Rguess,Rreal,Intensity,Rangey,Rangex,Gkernel,Rcut,codepath,M,N)
%two particle
cd(codepath);
%
mkdir respar2p
...
if ifdo
    ...
    [imgr,PosGuess] = prepGolden_1p(im,Rguess,Rreal,Intensity);
    PosStep=[0.1,0.1,0.1,0.1];
%%
